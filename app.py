...
app.config.update(
    ...
    PROFILE={
        ...
        "name_first": os.getenv("NAME_FIRST", "Rohit"),
        "name_last": os.getenv("NAME_LAST", "Jain"),
        "bio": os.getenv("BIO", "Delivering resilient government portal engineering, secure API architectures, and localized, privacy-first enterprise automation loops."),
        "location": os.getenv("LOCATION", "Jaipur, Rajasthan"),
        "open_to": os.getenv("OPEN_TO", "Remote, Hybrid, Relocation"),
        "email": os.getenv("EMAIL", "engrohitjain5@gmail.com"),
        "phone": os.getenv("PHONE", "+91 89469 19241"),
    },
    GATEWAYS={
        "linkedin": os.getenv("LINKEDIN_URL", "https://linkedin.com/in/rohit-jain-061571a3"),
        "github": os.getenv("GITHUB_URL", "https://github.com/rislrohitjain/rohitjain-portfolio"),
        "live_portal": os.getenv("LIVE_PORTAL_URL", "https://rohitjain-resume.vercel.app/"),
        "resume": os.getenv("RESUME_DOWNLOAD_URL", "/Rohit_Jain_Resume.pdf"),
    },
    STATS={
